...
const char *server_introspection_xml =
    ...
    "    </method>\n"
    "    <method name='InstallPrmPackageReply'>\n"
    "       <arg type='u' direction='in' name='EfiStatus' />\n"
    "    </method>\n"
    "    <method name='EnumerateHandlersRequest'>\n"
    "    </method>\n"
    "    <method name='EnumerateHandlersReply'>\n"
    "       <arg type='u' direction='in' name='EfiStatus'>\n"
    "       <arg type='a{ss} direction='in' name='PrmHandlerInfo' />\n"
    "         <entry key='PlatformGuid' value='s'/>\n"
    "         <entry key='ModuleGuid' value='s'/>\n"
    "         <entry key='HandlerGuid' value='s'/>\n"
    "       </arg>\n"
    "    </method>\n"
    "    <method name='InvokeHandlerRequest'>\n"
    "       <arg type='s' direction='in' name='HandlerGuid'/>\n"
    "       <arg type='ay' direction='in' name='ParameterBuffer' optional='true'/>\n"
    "    </method>\n"
    "    <method name='InvokeHandlerRequestReply'>\n"
    "       <arg type='u' direction='in' name='PrmHandlerReturnStatus'/>\n"
    "       <arg type='u' direction='in' name='EfiStatus'/>\n"
    "    </method>\n"
    "    <method name='UninstallPrmModuleRequest'>\n"
    "       <arg type='s' direction='in' name='ModuleGuid'/>\n"
    "       <arg type='u' direction='out' name='EfiStatus'/>\n"
    "     </method>\n"
    "    <method name='UninstallPrmModuleReply'>\n"
    "       <arg type='u' direction='in' name='EfiStatus'/>\n"
    "     </method>\n"
    "     <method name='GetHandlerDebugInfoRequest'>\n"
    "       <arg type='s' direction='in' name='HandlerGuid'/>\n"
    ...
    "     </method>\n"
    "     <method name='GetHandlerDebugInfoReply'>\n"
    "       <arg type='ay' direction='in' name='AcpiParameterBuffer'/>\n"
    "       <arg type='s' direction='in' name='HandlerName' />\n"
    "       <arg type='u' durection='in' name='EfiStatus'/>\n"
    "     </method>\n"
    "    <method name='Quit'>\n"
	  "    </method>\n"
    "  </interface>\n"
