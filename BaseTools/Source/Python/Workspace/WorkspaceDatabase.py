...
class DscBuildData(PlatformBuildClassObject):
    ...
    def GetStructurePcdMaxSize(self, str_pcd):
        ...
        sku_value = str_pcd.SkuInfoList.values()[0].DefaultValue
        ...
        def get_length(value):
            ...
            if Value[0] == "'" and Value[-1] == "'" and len(list(Value[1:-1])) > 1:
                return len(Value) - 2
            return len(Value)  
        return str(max(get_length(pcd_default_value), get_length(sku_value)))
    ...
    def GenerateByteArrayValue (self,StructuredPcds):
        ...
        for PcdName in StructuredPcds:
            Pcd = StructuredPcds[PcdName]
            CApp = CApp + 'void\n'
            CApp = CApp + 'Initialize_%s_%s_%s_%s(\n' % (Pcd.SkuName, Pcd.DefaultStoreName, Pcd.TokenSpaceGuidCName, Pcd.TokenCName)
            CApp = CApp + '  void\n'
            CApp = CApp + '  )\n'
            CApp = CApp + '{\n'
            ...
            CApp = CApp + '\n'
            InitByteValue += '%s.%s.%s.%s|%s|%s\n' % (Pcd.SkuName, Pcd.DefaultStoreName, Pcd.TokenSpaceGuidCName, Pcd.TokenCName, Pcd.DatumType, Pcd.DefaultValue)
